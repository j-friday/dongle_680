...
/// Macro to read a INT register	////????
#define REG_INT_RD(addr)              (*(volatile uint32_t *)(addr))

/// Macro to write a INT register	////????
#define REG_INT_WR(addr, value)       (*(volatile uint32_t *)(addr)) = (value)
