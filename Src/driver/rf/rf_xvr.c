...
#if 0
void xvr_reg_initial_o(void) 
{

    addXVR_Reg0x0 = 0xC4B03210  ;XVR_ANALOG_REG_BAK[0] = 0xC4B03210;
    addXVR_Reg0x1 = 0x8295C100  ;XVR_ANALOG_REG_BAK[1] = 0x8295C100;
    addXVR_Reg0x2 = 0x2F62A000  ;XVR_ANALOG_REG_BAK[2] = 0x2F62A000;
    addXVR_Reg0x3 = 0x60035C62  ;XVR_ANALOG_REG_BAK[3] = 0x60035C62;
   
    addXVR_Reg0x4 = 0x5FC3FDCF  ;XVR_ANALOG_REG_BAK[4] = 0x5FC3FDCF;//0xFFD6BBCC
    addXVR_Reg0x5 = 0x4820503F  ;XVR_ANALOG_REG_BAK[5] = 0x4820503F;
    addXVR_Reg0x6 = 0x8097CEA0  ;XVR_ANALOG_REG_BAK[6] = 0x8097CEA0;
    addXVR_Reg0x7 = 0xAA023FC0  ;XVR_ANALOG_REG_BAK[7] = 0xAA023FC0;
    addXVR_Reg0x8 = 0x87F8C025  ;XVR_ANALOG_REG_BAK[8] = 0x87F8C025;
    addXVR_Reg0x9 = 0x7493220C  ;XVR_ANALOG_REG_BAK[9] = 0x7493220C; //0x7093220C RC
    ...
    addXVR_Reg0x1e = 0x00010180  ;XVR_ANALOG_REG_BAK[0x1e] = 0x00010180;
    ...
    addXVR_Reg0x3c = 0x01FF1c00;// REG_3C
...
//        bk_printf("BLE_RADIOTXRXTIM1 addr:0x%08x,val:0x%08x\r\n",BLE_RADIOTXRXTIM1_ADDR,ble_radiotxrxtim1_get());
...
{
    rf_power_leave = leave & 0x0F;
    addXVR_Reg0x24 &= ~(0x01 << 20);
    addXVR_Reg0x24 &= ~(0xF << 7);
    addXVR_Reg0x24 |= (rf_power_leave << 7);  
}
