...
//	os_printf("MUSB_MsdConnect Function is called\r\n");
    ...
    os_printf("MUSB_MsdConnect start\r\n");
    /* Device is connected */
...
//				    break;
    ...
    if(pProtocol)
    {
        ...
        os_printf("MUSB_MsdConnect: pMsdDevice = 0x%p\r\n", pMsdDevice);
		if(pMsdDevice)
		{
...
/*此处为设置setup configuration包*/
    ...
    os_printf("MGC_MsdConfigureDevice\r\n");
