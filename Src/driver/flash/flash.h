 ...
 ****************************************************************************************
 */
uint8_t flash_write(uint32_t flash_id, uint32_t offset, uint32_t length, uint8_t *buffer, void (*callback)(void));
 ...
 ****************************************************************************************
 */
uint8_t flash_read(uint32_t flash_id, uint32_t offset, uint32_t length, uint8_t *buffer, void (*callback)(void));
