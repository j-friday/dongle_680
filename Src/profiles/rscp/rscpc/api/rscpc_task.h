...
enum rscpc_msg_ids
{
    ...
    RSCPC_ENABLE_REQ = TASK_FIRST_MSG(TASK_ID_RSCPC),//!< RSCPC_ENABLE_REQ
    /// Enable the Running Speed and Cadence Profile Collector task - at connection
    RSCPC_ENABLE_RSP,                                //!< RSCPC_ENABLE_RSP

    /// Read the value of an attribute in the peer device database
    RSCPC_READ_CMD,                                  //!< RSCPC_READ_CMD
    /// Configure sending of notification or indication
    RSCPC_CFG_NTFIND_CMD,                            //!< RSCPC_CFG_NTFIND_CMD

    /// Configure the SC Control Point value
    RSCPC_CTNL_PT_CFG_REQ,                           //!< RSCPC_CTNL_PT_CFG_REQ
    /// SC Control Point value response
    RSCPC_CTNL_PT_CFG_RSP,                           //!< RSCPC_CTNL_PT_CFG_RSP

    /// Indicate that an attribute value has been received either upon notification or read response
    RSCPC_VALUE_IND,                                 //!< RSCPC_VALUE_IND

    /// Complete Event Information
    RSCPC_CMP_EVT,                                   //!< RSCPC_CMP_EVT

    /// Procedure Timeout Timer
    RSCPC_TIMEOUT_TIMER_IND,                         //!< RSCPC_TIMEOUT_TIMER_IND
};
