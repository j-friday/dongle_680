...
#define OAD_BLOCK_APP_MAX        (0x2000)  //(128K *1024*4) /64
#define OAD_BLOCK_STACK_MAX		 (0x3E00)//248 kb not support

typedef void (*FUNCPTR)(void);

#define SEC_IMAGE_OAD_HEADER_APP_FADDR		 (0x308a0) 																		
#define SEC_IMAGE_OAD_HEADER_STACK_FADDR	 (0x20e0) 

#define SEC_BACKUP_OAD_HEADER_FADDR			 (0x54000) //336 * 1024
#define SEC_BACKUP_OAD_IMAGE_FADDR			 (0x54010) //336* 1024 + 0X10
#define SEC_BACKUP_ALLOC_START_FADDR		 (0x54000) //(336KB)  //7d000  max store size 164kb
/*********************************************************************
 * MACROS
 */   
