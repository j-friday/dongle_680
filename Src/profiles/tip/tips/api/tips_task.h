...
enum tips_msg_id
{
    ...
    TIPS_ENABLE_REQ = TASK_FIRST_MSG(TASK_ID_TIPS),//!< TIPS_ENABLE_REQ
    ///Inform the application about the task creation result
    TIPS_ENABLE_RSP,                               //!< TIPS_ENABLE_RSP

    ///Update Current Time Request from APP
    TIPS_UPD_CURR_TIME_REQ,                        //!< TIPS_UPD_CURR_TIME_REQ
    ///Update Current Time Response to APP
    TIPS_UPD_CURR_TIME_RSP,                        //!< TIPS_UPD_CURR_TIME_RSP

    ///Inform APP about a requested read
    TIPS_RD_REQ_IND,                               //!< TIPS_RD_REQ_IND
    ///Read request Response
    TIPS_RD_CFM,                                   //!< TIPS_RD_CFM

    ///Inform APP about modification of Current Time Characteristic Client. Charact. Cfg
    TIPS_CURRENT_TIME_CCC_IND,                     //!< TIPS_CURRENT_TIME_CCC_IND
    ///Inform APP about modification of Time Update Control Point Characteristic Value
    TIPS_TIME_UPD_CTNL_PT_IND,                     //!< TIPS_TIME_UPD_CTNL_PT_IND
};
