...
enum cscpc_msg_ids
{
    ...
    CSCPC_ENABLE_REQ = TASK_FIRST_MSG(TASK_ID_CSCPC),//!< CSCPC_ENABLE_REQ
    /// Enable the Cycling Speed and Cadence Profile Collector task - at connection
    CSCPC_ENABLE_RSP,                                //!< CSCPC_ENABLE_RSP

    /// Read the value of an attribute in the peer device database
    CSCPC_READ_CMD,                                  //!< CSCPC_READ_CMD

    /// Configure sending of notification or indication
    CSCPC_CFG_NTFIND_CMD,                            //!< CSCPC_CFG_NTFIND_CMD

    /// Configure the SC Control Point value
    CSCPC_CTNL_PT_CFG_REQ,                           //!< CSCPC_CTNL_PT_CFG_REQ
    /// SC Control Point value response
    CSCPC_CTNL_PT_RSP,                               //!< CSCPC_CTNL_PT_RSP

    /// Indicate that an attribute value has been received either upon notification or read response
    CSCPC_VALUE_IND,                                 //!< CSCPC_VALUE_IND

    /// Complete Event Information
    CSCPC_CMP_EVT,                                   //!< CSCPC_CMP_EVT

    /// Procedure Timeout Timer
    CSCPC_TIMEOUT_TIMER_IND,                         //!< CSCPC_TIMEOUT_TIMER_IND
};
