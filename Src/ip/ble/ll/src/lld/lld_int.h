...
#define LLD_ALLOC_EVT(data_struct)           (struct data_struct *) ke_malloc(sizeof(struct data_struct), KE_MEM_ENV);
...
#define LLD_PROG_DELAY          2   // 3
#define LLD_PROG_DELAY_MIN      1 // 2
...
#define BLE_PREFETCHABORT_TIME_US  (200)
...
#define LLD_RX_AUX_PTR_THR   (0xFF) // 255 x 16 = 4080us (max value)
 ...
 ****************************************************************************************
 */
void lld_per_adv_init(bool reset);
