 ...
 ****************************************************************************************
 */
bool attm_uuid_comp(const uint8_t *uuid_a, uint8_t uuid_a_len, const uint8_t *uuid_b, uint8_t uuid_b_len);
 ...
 ****************************************************************************************
 */
bool attm_uuid16_comp(const uint8_t *uuid_a, uint8_t uuid_a_len, uint16_t uuid_b);
 ...
 ****************************************************************************************
 */
bool attm_is_bt16_uuid(const uint8_t *uuid);
 ...
 ****************************************************************************************
 */
bool attm_is_bt32_uuid(const uint8_t *uuid);
