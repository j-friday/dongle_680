...
void sch_prog_next_ts_set(uint32_t timestamp);

uint32_t sch_prog_next_ts_get(void);

void sch_prog_next_hts_set(uint32_t next_bit_off);

uint32_t sch_prog_next_hts_get(void);
